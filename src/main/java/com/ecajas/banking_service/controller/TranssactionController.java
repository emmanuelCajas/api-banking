...
import com.ecajas.banking_service.services.TransactionService;
...
public class TranssactionController {
    ...
    public ResponseEntity<List<TransactionResponseDTO>> getTransactionByAccountNumber(
            @PathVariable String accountNumber){
        List<TransactionResponseDTO> transactions = transactionService
                .getTransactionByAccountNumber(accountNumber);
